...
if __name__ == '__main__':
    # Default to Pearl OS Gerrit
    default_gerrit = 'http://gerrit.pearlos.com'
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit pearl', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch pearl', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
